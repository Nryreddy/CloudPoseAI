...
def main():
    try:
        ...
        model = YOLO('app\model1-yolox\yolo11x-pose.pt')
        # Load a pretrained YOLOv11x pose model
        log.info("Model is loaded.")
        # Predict on an image
        image_path = "app\model1-yolox\\test.jpg"  # Replace with your image path
        output_image = 'app\model1-yolox\\test_with_keypoints.jpg'
